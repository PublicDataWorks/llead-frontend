...
import DocumentsItem from 'components/common/items/document-item'
...
describe('Documents Item', () => {
  it('should render correctly with normal content', () => {
    ...
    const container = render(<DocumentsItem {...document} highlighting />)
  ...
  it('should render incidentDate only', () => {
    const document = {
      id: 2,
      documentType: 'csv',
      url: 'https://i.imgur.com/document2.csv',
    ...
    expect(documentItemHighlight.length).toEqual(0)
  })
})
