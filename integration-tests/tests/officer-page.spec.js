    ...
    describe('officer timeline', () => {
      it('renders officer timeline', () => {
        ...
        cy.get('@secondTimelineGroup')
          ...
          .should('text', 'Left department Slidell PD')
        ...
        cy.get('@thirdTimelineGroup')
          .find('.timeline-item')
          .eq(0)
          .should('text', 'Joined department Slidell PD')
        cy.get('@thirdTimelineGroup')
          .find('.timeline-item')
          .eq(1)
          .should('text', 'Left department Mandeville PD')
        cy.get('@thirdTimelineGroup')
          .find('.timeline-item')
          .eq(2)
        ...
        cy.get('@forthTimelineGroup')
          ...
          .eq(0)
          .find('.timeline-main-item')
          .should('text', 'Joined department Mandeville PD')
        cy.get('@forthTimelineGroup')
          .find('.timeline-item')
          .eq(1)
          .find('.complaint-item-title')
